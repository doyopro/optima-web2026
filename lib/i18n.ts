...
export const translations = {
  en: {
    ...
    propertyEnquiry: {
      ...
      subtitle: "Tell us what you're looking for and our local team will get back to you with availability and a quote.",
      name: 'Name',
      email: 'Email',
      phone: 'Phone',
      propertyInterest: 'Villa (if known)',
      propertyInterestPlaceholder: "Not sure yet — that's fine",
      checkIn: 'Check-in',
      checkOut: 'Check-out',
      guests: 'Guests',
      message: 'Message',
      ...
      thankYouText: "We've received your enquiry and a member of our local team will be in touch shortly with availability and a quote.",
      thankYouBack: 'Back to villas',
    },
    blog: {
      title: 'Blog',
    ...
    guidesPage: {
      ...
      loadError: 'We could not load this content right now.',
      retry: 'Retry',
      empty: 'No content available yet.',
      hero: {
        title: 'Plan Your Lanzarote Adventure',
        subtitle: 'Everything you need to know about Playa Blanca, Lanzarote & the Canary Islands',
        cta: 'Explore guides',
      },
      stats: [
        { value: '300+', label: 'days of sunshine' },
        { value: '17–29°C', label: 'year-round' },
        { value: '25 min', label: 'ferry to Fuerteventura' },
      ],
      sectionTitles: {
        'playa-blanca': { title: 'Playa Blanca', subtitle: 'Beaches, things to do, practical info' },
        climate: { title: 'Climate & Weather', subtitle: 'Monthly temperatures, best time to visit' },
        ferries: { title: 'Ferries', subtitle: 'Schedules & prices to Fuerteventura & La Graciosa' },
        beaches: { title: 'Beaches', subtitle: 'Top beaches + hidden gems' },
      },
      bonus: {
        title: 'More to explore',
        items: [
          { emoji: '🚌', title: 'Getting Around', description: 'Buses, car hire and driving on the island' },
          { emoji: '🍽️', title: 'Food & Restaurants', description: "Playa Blanca's best spots to eat and drink" },
          { emoji: '🎭', title: 'Day Trips & Excursions', description: 'Timanfaya, La Geria, the north and beyond' },
        ],
      },
      bottomCta: { text: 'Have a question?', cta: 'Message us on WhatsApp' },
      filters: { all: 'All', family: 'Family', surfer: 'Surf', scenic: 'Scenic', secluded: 'Secluded' },
      beachesOverview: 'Lanzarote has 40+ named beaches with something for everyone. Swimming is possible year-round, with sea temperatures of 18–23°C.',
      emergencyNote: 'For any emergency (ambulance, police or fire), dial the EU-wide number',
      mapTitle: 'Map',
      ...
      heroAlt: {
        index: 'Volcanic landscape and coastline of Lanzarote',
        'playa-blanca': 'Playa Blanca coastline and beaches, Lanzarote',
        climate: 'Sunny volcanic landscape in Lanzarote',
        ferries: 'Ferry port in Playa Blanca, Lanzarote',
        beaches: 'A beach in Lanzarote',
      },
    },
    dashboard: {
      title: 'Dashboard',
    ...
    guidesAdmin: {
      ...
      newFerry: 'New ferry',
      fields: {
        section: 'Section', slug: 'Slug', contentEn: 'Content (EN)', contentEs: 'Content (ES)',
        nameEn: 'Name (EN)', nameEs: 'Name (ES)', descriptionEn: 'Description (EN)', descriptionEs: 'Description (ES)',
        location: 'Location', distanceKm: 'Distance (km)', sandType: 'Sand type', difficulty: 'Difficulty (1-3)',
        beachType: 'Beach type (JSON)', amenities: 'Amenities (JSON)', latitude: 'Latitude', longitude: 'Longitude',
        imageUrl: 'Image URL', rating: 'Rating',
        name: 'Company', routeFrom: 'Route from', routeTo: 'Route to', durationMinutes: 'Duration (min)',
        frequencyDaily: 'Sailings/day', priceEur: 'Price (€)', website: 'Website', contactPhone: 'Phone',
        luggageLimitKg: 'Luggage limit (kg)', notesEn: 'Notes (EN)', notesEs: 'Notes (ES)',
      },
      columns: {
        section: 'Section', slug: 'Slug', published: 'Published', actions: 'Actions',
        nameEn: 'Name EN', nameEs: 'Name ES', location: 'Location', difficulty: 'Difficulty', rating: 'Rating',
        company: 'Company', route: 'Route', duration: 'Duration', price: 'Price',
      },
    },
    guestPortal: {
      navLink: 'Manage my booking',
      login: {
        title: 'Manage your booking',
        subtitle: 'Enter your email and last name to see all your bookings with us.',
        emailLabel: 'Email',
        bookingCodeLabel: 'Booking code',
        lastNameLabel: 'Last name',
        submit: 'Access my bookings',
        loading: 'Checking…',
        error: "We couldn't find a booking matching those details. Please check and try again.",
        useBookingCodeInstead: "Don't want to use email? Log in with your booking code instead",
        useEmailInstead: 'Log in with email instead',
        bookingCodeSubtitle: 'Enter your booking code and last name to access that booking.',
      },
      dashboard: {
        title: 'Your booking',
        ...
        past: 'Past bookings',
        noReservations: "We couldn't find any bookings on this account.",
        viewDetails: 'View details →',
        property: 'Property',
        checkIn: 'Check-in',
        checkOut: 'Check-out',
        ...
        pending: 'Pending',
        amount: 'Amount',
        formLink: 'Guest information form',
        formSub: 'Tell us who is staying with you',
        logout: 'Log out',
        back: '← Back to my booking',
        backToBookings: '← Back to all bookings',
      },
      payments: {
        ...
        balanceDue: 'Balance due',
        balanceDueDate: 'Due by',
        fullyPaid: 'Fully paid — thank you!',
        history: 'Payments received',
        historyEmpty: 'No payments recorded yet.',
        payBalanceCta: 'Pay towards your balance',
        payBalanceLabel: 'Amount to pay',
        payBalanceHint: 'Enter any amount up to your remaining balance of {amount}.',
        payBalanceSubmit: 'Pay now',
        payBalanceSubmitting: 'Processing…',
        payBalanceSuccess: 'Payment received — thank you!',
        payBalanceError: 'Something went wrong processing your payment. Please try again.',
        payBalanceInvalidAmount: 'Enter an amount greater than 0 and no more than your remaining balance.',
      },
      form: {
        title: 'Guest information',
        step: 'Guest {current} of {total}: {name}',
        stepUnnamed: 'Guest {current} of {total}',
        fullName: 'Full name',
        fullNamePlaceholder: 'Guest name (optional)',
        age: 'Age',
        nationality: 'Nationality',
        selectNationality: 'Select country',
        passport: 'Passport / ID number',
        email: 'Email',
        phone: 'Phone',
        optional: 'Optional',
        sameAsBooking: 'Same as booking, if left blank',
        next: 'Next',
        back: 'Back',
        submit: 'Save',
        error: 'Failed to save — please try again.',
        allSaved: 'All guest information saved. Thank you!',
      },
    },
  },
  es: {
    ...
    home: {
      ...
      optimaDifference: {
        ...
        items: [
          {
            title: 'ESPECIALISTAS EN LANZAROTE',
            description:
    ...
    propertyEnquiry: {
      title: 'Consulta sobre una estancia',
      subtitle: 'Contanos qué estás buscando y nuestro equipo local te responderá con disponibilidad y presupuesto.',
      name: 'Nombre',
      email: 'Correo electrónico',
      phone: 'Teléfono',
      propertyInterest: 'Villa (si ya sabés cuál)',
      propertyInterestPlaceholder: 'Todavía no lo sé — está bien',
      checkIn: 'Entrada',
      checkOut: 'Salida',
      guests: 'Huéspedes',
      message: 'Mensaje',
      ...
      thankYouTitle: 'Gracias por tu consulta',
      thankYouText: 'Hemos recibido tu consulta y un miembro de nuestro equipo local se pondrá en contacto pronto con disponibilidad y presupuesto.',
      thankYouBack: 'Volver a las villas',
    },
    blog: {
      title: 'Blog',
    ...
    footer: {
      ...
      links: {
        ...
        enquire: 'Consultar sobre una estancia',
    ...
    guidesPage: {
      ...
      loadError: 'No hemos podido cargar este contenido ahora mismo.',
      retry: 'Reintentar',
      empty: 'Todavía no hay contenido disponible.',
      hero: {
        title: 'Planea tu aventura en Lanzarote',
        subtitle: 'Todo lo que necesitas saber sobre Playa Blanca, Lanzarote y las Islas Canarias',
        cta: 'Explorar guías',
      },
      stats: [
        { value: '300+', label: 'días de sol' },
        { value: '17–29°C', label: 'todo el año' },
        { value: '25 min', label: 'en ferry a Fuerteventura' },
      ],
      sectionTitles: {
        'playa-blanca': { title: 'Playa Blanca', subtitle: 'Playas, qué hacer y datos prácticos' },
        climate: { title: 'Clima y Tiempo', subtitle: 'Temperaturas mensuales, mejor época para viajar' },
        ferries: { title: 'Ferris', subtitle: 'Horarios y precios a Fuerteventura y La Graciosa' },
        beaches: { title: 'Playas', subtitle: 'Las mejores playas + rincones escondidos' },
      },
      bonus: {
        title: 'Más para explorar',
        items: [
          { emoji: '🚌', title: 'Cómo moverte', description: 'Autobuses, alquiler de coche y conducir en la isla' },
          { emoji: '🍽️', title: 'Comida y restaurantes', description: 'Los mejores sitios para comer y beber en Playa Blanca' },
          { emoji: '🎭', title: 'Excursiones de un día', description: 'Timanfaya, La Geria, el norte de la isla y más' },
        ],
      },
      bottomCta: { text: '¿Tienes alguna pregunta?', cta: 'Escríbenos por WhatsApp' },
      filters: { all: 'Todas', family: 'Familia', surfer: 'Surf', scenic: 'Paisaje', secluded: 'Aislada' },
      beachesOverview: 'Lanzarote tiene más de 40 playas con nombre propio, para todos los gustos. Se puede nadar todo el año, con temperaturas del mar de 18–23°C.',
      emergencyNote: 'Para cualquier emergencia (ambulancia, policía o bomberos), marca el número europeo',
      mapTitle: 'Mapa',
      ...
      heroAlt: {
        index: 'Paisaje volcánico y costa de Lanzarote',
        'playa-blanca': 'Costa y playas de Playa Blanca, Lanzarote',
        climate: 'Paisaje volcánico soleado en Lanzarote',
        ferries: 'Puerto de ferris en Playa Blanca, Lanzarote',
        beaches: 'Una playa en Lanzarote',
      },
    },
    dashboard: {
      title: 'Panel',
    ...
    guidesAdmin: {
      ...
      tabs: { content: 'Contenido de guías', beaches: 'Playas', ferries: 'Ferris' },
      published: 'Publicado',
      ...
      retry: 'Reintentar',
      newBeach: 'Nueva playa',
      newFerry: 'Nuevo ferry',
      fields: {
        section: 'Sección', slug: 'Slug', contentEn: 'Contenido (EN)', contentEs: 'Contenido (ES)',
        nameEn: 'Nombre (EN)', nameEs: 'Nombre (ES)', descriptionEn: 'Descripción (EN)', descriptionEs: 'Descripción (ES)',
        location: 'Ubicación', distanceKm: 'Distancia (km)', sandType: 'Tipo de arena', difficulty: 'Dificultad (1-3)',
        beachType: 'Tipo de playa (JSON)', amenities: 'Servicios (JSON)', latitude: 'Latitud', longitude: 'Longitud',
        imageUrl: 'URL de imagen', rating: 'Valoración',
        name: 'Compañía', routeFrom: 'Ruta desde', routeTo: 'Ruta hasta', durationMinutes: 'Duración (min)',
        frequencyDaily: 'Salidas/día', priceEur: 'Precio (€)', website: 'Web', contactPhone: 'Teléfono',
        luggageLimitKg: 'Límite de equipaje (kg)', notesEn: 'Notas (EN)', notesEs: 'Notas (ES)',
      },
      columns: {
        section: 'Sección', slug: 'Slug', published: 'Publicado', actions: 'Acciones',
        nameEn: 'Nombre EN', nameEs: 'Nombre ES', location: 'Ubicación', difficulty: 'Dificultad', rating: 'Valoración',
        company: 'Compañía', route: 'Ruta', duration: 'Duración', price: 'Precio',
      },
    },
    guestPortal: {
      navLink: 'Gestiona tu reserva',
      login: {
        title: 'Gestiona tu reserva',
        subtitle: 'Introduce tu correo electrónico y apellido para ver todas tus reservas con nosotros.',
        emailLabel: 'Correo electrónico',
        bookingCodeLabel: 'Código de reserva',
        lastNameLabel: 'Apellido',
        submit: 'Acceder a mis reservas',
        loading: 'Comprobando…',
        error: 'No hemos encontrado ninguna reserva con esos datos. Revísalos e inténtalo de nuevo.',
        useBookingCodeInstead: '¿No querés usar tu correo? Accedé con tu código de reserva',
        useEmailInstead: 'Acceder con correo electrónico',
        bookingCodeSubtitle: 'Introduce tu código de reserva y apellido para acceder a esa reserva.',
      },
      dashboard: {
        title: 'Tu reserva',
        ...
        noReservations: 'No encontramos ninguna reserva en esta cuenta.',
        viewDetails: 'Ver detalles →',
        property: 'Propiedad',
        checkIn: 'Entrada',
        checkOut: 'Salida',
        ...
        pending: 'Pendiente',
        amount: 'Importe',
        formLink: 'Formulario de huéspedes',
        formSub: 'Dinos quién se aloja contigo',
        logout: 'Cerrar sesión',
        back: '← Volver a mi reserva',
        backToBookings: '← Volver a todas mis reservas',
      },
      payments: {
        ...
        balanceDue: 'Saldo pendiente',
        balanceDueDate: 'Vence el',
        fullyPaid: '¡Pagado en su totalidad — gracias!',
        history: 'Pagos recibidos',
        historyEmpty: 'Todavía no hay pagos registrados.',
        payBalanceCta: 'Pagar a cuenta del saldo',
        payBalanceLabel: 'Importe a pagar',
        payBalanceHint: 'Introduce cualquier importe hasta tu saldo pendiente de {amount}.',
        payBalanceSubmit: 'Pagar ahora',
        payBalanceSubmitting: 'Procesando…',
        payBalanceSuccess: '¡Pago recibido — gracias!',
        payBalanceError: 'Algo salió mal al procesar tu pago. Por favor inténtalo de nuevo.',
        payBalanceInvalidAmount: 'Introduce un importe mayor a 0 y no superior a tu saldo pendiente.',
      },
      form: {
        title: 'Información de huéspedes',
        step: 'Huésped {current} de {total}: {name}',
        stepUnnamed: 'Huésped {current} de {total}',
        fullName: 'Nombre completo',
        fullNamePlaceholder: 'Nombre del huésped (opcional)',
        age: 'Edad',
        nationality: 'Nacionalidad',
        selectNationality: 'Selecciona un país',
        passport: 'Pasaporte / DNI',
        email: 'Correo electrónico',
        phone: 'Teléfono',
        optional: 'Opcional',
        sameAsBooking: 'Igual que en la reserva, si se deja en blanco',
        next: 'Siguiente',
        back: 'Atrás',
        submit: 'Guardar',
        error: 'Error al guardar — inténtalo de nuevo.',
        allSaved: 'Información de todos los huéspedes guardada. ¡Gracias!',
      },
    },
  },
} as const
