...
const SLUG = 'playa-blanca'
const HERO_IMAGE = '/lanzarote2.jpg'
    ...
    <>
      <div className="min-h-screen bg-cream">
        <div className="relative h-[300px] sm:h-[380px] w-full overflow-hidden">
          <Image src={HERO_IMAGE} alt={t.guidesPage.heroAlt["playa-blanca"]} fill priority className="object-cover" />
          ...
          <div className="pb-6">
            ...
            <div className="mt-8 bg-red-50 border border-red-100 rounded-2xl p-5">
              <p className="text-sm text-dark/70">
                {g.emergencyNote} <span className="font-bold text-red-600">112</span>.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <Link href="/guides/beaches" className="text-sm font-semibold text-orange hover:underline">
                {lang === 'es' ? 'Ver playas →' : 'See beaches →'}
              </Link>
              <Link href="/guides/ferries" className="text-sm font-semibold text-orange hover:underline">
                {lang === 'es' ? 'Ver ferris →' : 'See ferries →'}
              </Link>
            </div>
          </div>
