        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="https://www.instagram.com/optimavillaslanzarote?igsh=eDU2ZDRtNmFzbjZ0"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/guides" className="hover:text-orange transition-colors">{f.links.guides}</Link></li>
              ...
              <li><Link href="/guest-login" className="hover:text-orange transition-colors">{f.links.manageBooking}</Link></li>
            </ul>
          </div>
